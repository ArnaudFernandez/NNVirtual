...
<head>
    ...
    <link href="<?php echo $basePath ?>css/noNameVirtualCustomClass.css" rel="stylesheet"/>
    <link href="<?php echo $basePath ?>css/royal-preload.css" rel="stylesheet"/>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
    <!-- REVOLUTION SLIDER CSS -->
    <link href="<?php echo $basePath ?>plugins/revolution/revolution/css/settings.css" rel="stylesheet" type="text/css">
    <!-- REVOLUTION NAVIGATION STYLE -->
    <link href="<?php echo $basePath ?>plugins/revolution/revolution/css/navigation.css" rel="stylesheet" type="text/css">

    <link href="<?php echo $basePath ?>images/Logo%20entete%20site.webp" rel="shortcut icon" type="image/x-icon"/>
    <link rel="icon" href="<?php echo $basePath ?>images/Logo%20entete%20site.webp" sizes="32x32" />
