...
(function ($) {
  ...
  tooltipWrapper.addEventListener('mouseover', function () {
    var tooltip = tooltipWrapper.querySelector('.tooltip');
    tooltip.style.bottom = "100%";
  });
  tooltipWrapper.addEventListener('mouseout', function () {
    var tooltip = tooltipWrapper.querySelector('.tooltip');
  ...
  $('.real-numbers').each(function () {
    ...
    swt.on('change', function () {
      ...
      if (this.checked) {
        ...
        parent.find('.stopwatchPointer').addClass('stopwatchPointerActive');
        ...
        parent.find('.stopwatchPointer').removeClass('stopwatchPointerActive');
  ...
  * --------------------------------------------------*/
  ...
  $(window).load(function () {
    $('.particles-js-b').each(function () {
      ...
      var _update2;
      _update2 = function update() {
        requestAnimationFrame(_update2);
      };
      requestAnimationFrame(_update2);
    });
  });
